                ...
                <CardActions sx={{display: 'flex', justifyContent: 'end'}}>
                    {
                        ...
                        <Button onClick={(e) => onPreview(motion)} disabled={disabled}>{t("preview")}</Button>
                    }
                    {
                    ...
                    }
                    {
                        ...
                        <Button onClick={(e) => onViewResults(motion)} disabled={showResultsDisabled}>{t("result")}</Button>
                    }
                </CardActions>
            }
        </Card>
