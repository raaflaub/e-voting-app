...
import { PatchEventMotionRequestDocument } from '../models';
import { PatchEventRequestDocument } from '../models';
...
export const EventApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {PatchEventMotionRequestDocument} [body] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        jsonapiV1EventsEventIdMotionsMotionIdPatch: async (eventId: string, motionId: string, body?: PatchEventMotionRequestDocument, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'eventId' is not null or undefined
            if (eventId === null || eventId === undefined) {
                throw new RequiredError('eventId','Required parameter eventId was null or undefined when calling jsonapiV1EventsEventIdMotionsMotionIdPatch.');
            }
            // verify required parameter 'motionId' is not null or undefined
            if (motionId === null || motionId === undefined) {
                throw new RequiredError('motionId','Required parameter motionId was null or undefined when calling jsonapiV1EventsEventIdMotionsMotionIdPatch.');
            }
            const localVarPath = `/jsonapi/v1/events/{eventId}/motions/{motionId}`
                .replace(`{${"eventId"}}`, encodeURIComponent(String(eventId)))
                .replace(`{${"motionId"}}`, encodeURIComponent(String(motionId)));
         ...
         * 
         * @param {string} id 
         * @param {PatchEventRequestDocument} [body] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        jsonapiV1EventsIdPatch: async (id: string, body?: PatchEventRequestDocument, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling jsonapiV1EventsIdPatch.');
            }
            const localVarPath = `/jsonapi/v1/events/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const EventApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async jsonapiV1EventsEventIdMotionsMotionIdPatch(eventId: string, motionId: string, body?: PatchEventMotionRequestDocument, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await EventApiAxiosParamCreator(configuration).jsonapiV1EventsEventIdMotionsMotionIdPatch(eventId, motionId, body, options);
         ...
         * @throws {RequiredError}
         */
        async jsonapiV1EventsIdPatch(id: string, body?: PatchEventRequestDocument, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await EventApiAxiosParamCreator(configuration).jsonapiV1EventsIdPatch(id, body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const EventApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async jsonapiV1EventsEventIdMotionsMotionIdPatch(eventId: string, motionId: string, body?: PatchEventMotionRequestDocument, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return EventApiFp(configuration).jsonapiV1EventsEventIdMotionsMotionIdPatch(eventId, motionId, body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
         ...
         * @throws {RequiredError}
         */
        async jsonapiV1EventsIdPatch(id: string, body?: PatchEventRequestDocument, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return EventApiFp(configuration).jsonapiV1EventsIdPatch(id, body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {PostEventRequestDocument} [body] 
...
export class EventApi extends BaseAPI {
     ...
     * @memberof EventApi
     */
    public async jsonapiV1EventsEventIdMotionsMotionIdPatch(eventId: string, motionId: string, body?: PatchEventMotionRequestDocument, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return EventApiFp(this.configuration).jsonapiV1EventsEventIdMotionsMotionIdPatch(eventId, motionId, body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {*} [options] Override http request option.
     ...
     * @memberof EventApi
     */
    public async jsonapiV1EventsIdPatch(id: string, body?: PatchEventRequestDocument, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return EventApiFp(this.configuration).jsonapiV1EventsIdPatch(id, body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {PostEventRequestDocument} [body] 
